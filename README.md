...
## Necessary
 ...
 - [ ] Create a separate subdirectory to store preprocessed files. Use naming conventions such as "filename\_preprocess\_options\_DATE". For example, "healthy\_rats\_min\_2021\_08\_01". Change main program to use appropriate preprocess files depending on `vars.conf`.
